...
public class EmployeeAllocationController {
	...
	public ResponseEntity<EmployeeAllocation> createEmployeeAllocation(
			@RequestBody EmployeeAllocationDTO employeeAllocationDto) {
		EmployeeAllocation createdEmployeeAllocation = employeeAllocationService
				.createEmployeeAllocation(employeeAllocationDto);
